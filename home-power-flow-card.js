...
(() => {
  ...
  class HomePowerFlowEditor extends HTMLElement {
    ...
    _render(){
      ...
      this.shadowRoot.querySelectorAll('[data-scale-device]').forEach(el=>el.addEventListener('input',e=>{const i=Number(el.dataset.scaleDevice);this._config.devices[i].scale=Number(e.target.value)/100;this._emit(false);}));
